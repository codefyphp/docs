...
CodefyPHP has a command bus called `Odin`.
...
!!! note "Note"
    ...
    $commandBus->execute($command);`[^1]
    [^1]: Fowler, M. (2003, November 23). _CommandOrientedInterface_. Martin fowler. https://www.martinfowler.com/eaaDev/DomainEvent.html
