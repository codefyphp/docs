...
* Full name: `\Qubus\View\Expression\NameExpression`
...
```php
public __construct(mixed $name, mixed $line): mixed
```
...
```php
public raw(mixed $compiler, mixed $indent): void
```
...
```php
public repr(mixed $compiler, mixed $indent): void
```
