...
* Full name: `\Qubus\Form\FormBuilder\ChoiceList`
* Parent class: [`\Qubus\Form\FormBuilder\Choice`](./Choice.md)
...
```php
public setValue(mixed $value): \Qubus\Form\FormBuilder\Control
```
