...
* Full name: `\Qubus\Form\FormBuilder\Fieldset`
* Parent class: [`\Qubus\Form\FormBuilder\Group`](./Group.md)

## Constants

| Constant  | Visibility | Type   | Value      |
|-----------|------------|--------|------------|
| `TAGNAME` | public     | string | 'fieldset' |
...
```php
protected \Qubus\Form\FormBuilder\Legend $legend
```
...
```php
public getLegend(): \Qubus\Form\FormBuilder\Legend
```
