...
* Full name: `\Qubus\Form\FormBuilder\Element`
...
```php
protected \Qubus\Form\FormBuilder\Element|null $builder
```
...
```php
protected \Qubus\Form\FormBuilder\Decorator[] $decorators
```
...
```php
public \Qubus\Form\FormBuilder\Attr[] $attr
```
