...
* Full name: `\Qubus\Form\FormBuilder\Hyperlink`
* Parent class: [`\Qubus\Form\FormBuilder\Action`](./Action.md)

## Constants

| Constant  | Visibility | Type   | Value |
|-----------|------------|--------|-------|
| `TAGNAME` | public     | string | 'a'   |
...
```php
public setUrl(string $url): \Qubus\Form\FormBuilder\Hyperlink
```
...
```php
public __construct(array $options = [], array $attrs = []): mixed
```
