...
* Full name: `\Qubus\Form\FormBuilder\ImageInput`
* Parent class: [`\Qubus\Form\FormBuilder\FileInput`](./FileInput.md)
...
```php
protected createInlineImage(string $file): string
```
...
```php
public __construct(array|null $name = null, array|null $description = null, array $attrs = [], array $options = []): mixed
```
...
|----------------|-----------------|---------------------------------------|
| `$name`        | **array\|null** |                                       |
| `$description` | **array\|null** | Description as displayed on the label |
...
```php
public setValue(string $value): \Qubus\Form\FormBuilder\FileInput
```
...
```php
public setName(string $name): \Qubus\Form\FormBuilder\Control
```
...
```php
public moveUploadedFile(string $destination): bool|string
```
...
| Parameter      | Type       | Description                                  |
|----------------|------------|----------------------------------------------|
| `$destination` | **string** | File name, glob expression or directory name |
...
```php
protected renderSelectButton(): string
```
...
```php
protected renderRemoveButton(): string|null
```
