...
* Full name: `\Qubus\ValueObjects\Geography\Longitude`
* Parent class: [`\Qubus\ValueObjects\Number\RealNumber`](../Number/RealNumber.md)
...
```php
public __construct(mixed $longitude): mixed
```
