...
* Full name: `\Qubus\ValueObjects\DateTime\Hour`
...
```php
public static fromNative(): \Qubus\ValueObjects\DateTime\Hour|\Qubus\ValueObjects\ValueObject
```
...
```php
public static now(): \Qubus\ValueObjects\DateTime\Hour
```
