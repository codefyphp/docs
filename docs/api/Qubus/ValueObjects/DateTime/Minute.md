...
* Full name: `\Qubus\ValueObjects\DateTime\Minute`
...
```php
public static fromNative(): \Qubus\ValueObjects\DateTime\Minute|\Qubus\ValueObjects\ValueObject
```
...
```php
public static now(): \Qubus\ValueObjects\DateTime\Minute
```
