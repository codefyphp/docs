...
* Full name: `\Qubus\ValueObjects\Web\NullQueryString`
* Parent class: [`\Qubus\ValueObjects\Web\UrlQueryString`](./UrlQueryString.md)
* This class implements:
[`\Qubus\ValueObjects\Web\QueryString`](./QueryString.md)
...
```php
public toDictionary(): \Qubus\ValueObjects\Structure\Dictionary
```
