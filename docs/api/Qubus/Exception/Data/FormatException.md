...
* Full name: `\Qubus\Exception\Data\FormatException`
...
```php
public __construct(string $message = &#039;The data provided is not of the expected format or cannot be parsed correctly.&#039;, int $code, ?\Throwable $previous = null): mixed
```
