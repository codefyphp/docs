...
* Full name: `\Qubus\Exception\Http\LockedHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Locked', ?\Throwable $previous = null): mixed
```
