...
* Full name: `\Qubus\Exception\Http\UnauthorizedHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Unauthorized', ?\Throwable $previous = null): mixed
```
