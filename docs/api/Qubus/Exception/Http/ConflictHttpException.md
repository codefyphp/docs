...
* Full name: `\Qubus\Exception\Http\ConflictHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Conflict', ?\Throwable $previous = null): mixed
```
