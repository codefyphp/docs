...
* Full name: `\Qubus\Exception\Http\BadRequestHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Bad Request', ?\Throwable $previous = null): mixed
```
