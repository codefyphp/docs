...
* Full name: `\Qubus\Exception\Http\MethodNotAllowedHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Method Not Allowed', ?\Throwable $previous = null): mixed
```
