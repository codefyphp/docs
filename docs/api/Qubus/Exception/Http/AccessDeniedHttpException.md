...
* Full name: `\Qubus\Exception\Http\AccessDeniedHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Forbidden', ?\Throwable $previous = null): mixed
```
