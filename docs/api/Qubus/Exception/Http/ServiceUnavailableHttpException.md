...
* Full name: `\Qubus\Exception\Http\ServiceUnavailableHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Service Unavailable', ?\Throwable $previous = null): mixed
```
