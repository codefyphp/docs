...
* Full name: `\Qubus\Exception\Http\LengthRequiredHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Length Required', ?\Throwable $previous = null): mixed
```
