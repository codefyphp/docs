...
* Full name: `\Qubus\Exception\Http\InternalErrorHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Internal Server Error', ?\Throwable $previous = null): mixed
```
