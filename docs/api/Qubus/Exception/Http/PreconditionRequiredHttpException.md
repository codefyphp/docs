...
* Full name: `\Qubus\Exception\Http\PreconditionRequiredHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Precondition Required', ?\Throwable $previous = null): mixed
```
