...
* Full name: `\Qubus\Exception\Http\NotFoundHttpException`
...
```php
public __construct(\Psr\Http\Message\UriInterface|string|null $uri = null, string $message = 'Not Found', ?\Throwable $previous = null): mixed
```
