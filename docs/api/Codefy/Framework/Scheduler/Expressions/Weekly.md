...
* Full name: `\Codefy\Framework\Scheduler\Expressions\Weekly`
...
```php
public static make(int|string|array $weekday = 0, int|string|array $hour = 0, int|string|array $minute = 0): \Cron\CronExpression
```
