...
* Full name: `\Codefy\Framework\Scheduler\Expressions\Daily`
...
Sets the job execution time to run once per day.

```php
public static make(int|string|array $hour = 0, int|string|array $minute = 0): \Cron\CronExpression
```
