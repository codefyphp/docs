...
* Full name: `\Codefy\Framework\Scheduler\Expressions\Monthly`
...
```php
public static make(int|string|array $month = '*', int|string|array $day = 1, int|string|array $hour = 0, int|string|array $minute = 0): \Cron\CronExpression
```
