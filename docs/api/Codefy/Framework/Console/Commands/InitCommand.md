...
* Full name: `\Codefy\Framework\Console\Commands\InitCommand`
...
```php
protected initMigrationsDir(mixed $migrations, \Symfony\Component\Console\Output\OutputInterface $output): void
```
...
```php
protected initBootstrap(string $bootstrap, string $migrations, \Symfony\Component\Console\Output\OutputInterface $output): void
```
...
| Parameter     | Type                                                  | Description                                   |
|---------------|-------------------------------------------------------|-----------------------------------------------|
| `$bootstrap`  | **string**                                            | where to put bootstrap file.                  |
| `$migrations` | **string**                                            | path to migrations dir relative to bootstrap. |
| `$output`     | **\Symfony\Component\Console\Output\OutputInterface** |                                               |
