...
* Full name: `\Codefy\Framework\Console\Commands\ScheduleListCommand`
...
```php
public __construct(\Codefy\Framework\Scheduler\Schedule $schedule, \Codefy\Framework\Application $codefy): mixed
```
