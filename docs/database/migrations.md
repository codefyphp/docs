...
To roll back all migrations up to a specific migration you can specify the rollback target:
...
You can also roll back a specific migration using the down command:
